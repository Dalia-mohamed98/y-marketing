...
*/
 jQuery(document).ready(function($) {
    $('#blogbee-img-container li label img').click(function(){      
        $('#blogbee-img-container li').each(function(){
            $(this).find('img').removeClass ('blogbee-radio-img-selected') ;
        });
        $(this).addClass ('blogbee-radio-img-selected') ;
    }); 
    ...
    $( document ).on( 'click', '.customize_multi_add_field', blogbee_customize_multi_add_field )
        .on( 'change', '.customize_multi_single_field', blogbee_customize_multi_single_field )
        .on( 'click', '.customize_multi_remove_field', blogbee_customize_multi_remove_field )
    ...
    function blogbee_customize_multi_add_field(e) {
        ...
        e.preventDefault();
            ...
            blogbee_customize_multi_write( $control );
    }

    function blogbee_customize_multi_single_field() {
        var $control = $( this ).parents( '.customize_multi_input' );
        blogbee_customize_multi_write( $control );
    }

    function blogbee_customize_multi_remove_field(e) {
        e.preventDefault();
        var $this = $( this );
        var $control = $this.parents( '.customize_multi_input' );
        $this.parent().remove();
    ...
    function blogbee_customize_multi_write( $element) {
 ...
 jQuery(document).ready(function($) {
    $('#customize-control-theme_options-layout_options_blog #blogbee-img-container li label img').click(function(){      
        $('#customize-control-theme_options-layout_options_blog #blogbee-img-container li').each(function(){
            $(this).find('img').removeClass ('blogbee-radio-img-selected') ;
        });
        $(this).addClass ('blogbee-radio-img-selected') ;
    });  

    $('#customize-control-theme_options-layout_options_archive #blogbee-img-container li label img').click(function(){       
        $('#customize-control-theme_options-layout_options_archive #blogbee-img-container li').each(function(){
            $(this).find('img').removeClass ('blogbee-radio-img-selected') ;
        });
        $(this).addClass ('blogbee-radio-img-selected') ;
    });  

    $('#customize-control-theme_options-layout_options_page #blogbee-img-container li label img').click(function(){      
        $('#customize-control-theme_options-layout_options_page #blogbee-img-container li').each(function(){
            $(this).find('img').removeClass ('blogbee-radio-img-selected') ;
        });
        $(this).addClass ('blogbee-radio-img-selected') ;
    });  

    $('#customize-control-theme_options-layout_options_single #blogbee-img-container li label img').click(function(){        
        $('#customize-control-theme_options-layout_options_single #blogbee-img-container li').each(function(){
            $(this).find('img').removeClass ('blogbee-radio-img-selected') ;
        });
        $(this).addClass ('blogbee-radio-img-selected') ;
    });                 
