 ...
 */
function seokart_sanitize_checkbox( $checked ) {
	// Boolean check.
 ...
 */
function seokart_sanitize_hex_color( $hex_color, $setting ) {
 ...
 */
function seokart_sanitize_html( $html ) {
 ...
 */
function seokart_sanitize_image( $image, $setting ) {
 ...
 */
function seokart_sanitize_nohtml( $nohtml ) {
 ...
 */
function seokart_sanitize_number_absint( $number, $setting ) {
 ...
 *                    the setting default.
 */
function seokart_sanitize_range_value( $number, $setting ) {
 ...
 */
function seokart_sanitize_select( $input, $setting ) {
 ...
 */
function seokart_sanitize_url( $url ) {
	return esc_url_raw( $url );
}


/* Sanitization Text*/
function seokart_sanitize_text( $text ) {
	return wp_filter_post_kses( $text );
}

/* Sanitization Integer*/
function seokart_sanitize_integer( $input ) {
    if( is_numeric( $input ) ) {
        return intval( $input );
    }
}
