...
function business_consulting_dark_featured_title_subtitle(){
...
add_action( 'bizberg_before_homepage_blog', 'business_consulting_dark_featured_posts' );
function business_consulting_dark_featured_posts(){

	if( bizberg_get_theme_mod( 'featured_post_status' ) != true ){
		return;
	} ?>

    <section class="consulting-post featured_posts_wrapper">
        <div class="container">
            <div class="consulting-post-outer">
            	<div class="row">
            		<div class="col-lg-12 col-md-12 col-xs-12 title_subtitle_wrapper">
            			<?php 
            			$title_subtitle = business_consulting_dark_featured_title_subtitle();
            	...
            	if( $featured_query->have_posts() ): ?>
            		...
            		<div class="row">
	            		...
	            		while( $featured_query->have_posts() ): $featured_query->the_post();
		                    ...
		                    <div class="<?php business_consulting_dark_featured_col( $columns ); ?> mb-3">
		                        <div class="consulting-post-item">
		                            <div class="consulting-post-bg" style="background-image: url(<?php the_post_thumbnail_url( 'medium_large' ); ?>);"></div>

		                            <?php 
		                            if( !empty( $cat_name ) ){ ?>
		                            	<div class="consulting-post-cats">
		                            ...
		                            <div class="consulting-post-content">
		                                <div class="consulting-post-list">
		                                    <?php 
    ...
    <!-- consulting-post Ends -->
    <?php
}

function business_consulting_dark_featured_col( $col ){
